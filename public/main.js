...
rangeTextDesc.innerHTML = `
            <div class="legend">
                <div class="legendItem">
                    <img src="./images/coordCircle.png" class="legendPic">
                    <p>Alleged NELOS "Item" coordinates at center of circle with radius based on "Location Accuracy"</p>
                </div>
                <div class="legendItem">
                    <img src="./images/googleIcon.png" class="legendPic">
                    <p>Alleged Scene of Crime</p>
                </div>
                <div class="legendItem">
                    <img src="./images/homeIcon.png" class="legendPic">
